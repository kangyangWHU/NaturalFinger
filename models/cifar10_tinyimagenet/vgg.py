...
__all__ = [ 'vgg13_bn_cifar10', 'vgg13_bn_cifar10_trades', 'vgg16_bn_cifar10','vgg16_bn_cifar10_pgd',
            'vgg19_bn_cifar10', 'vgg19_bn_cifar10_pgd', "vgg13_bn_tinyimagenet", "vgg16_bn_tinyimagenet", "vgg19_bn_tinyimagenet",
...
def vgg13_bn_tinyimagenet():
    return VGG(make_layers(cfgs['B'], batch_norm=True), num_classes=50)
...
def vgg16_bn_tinyimagenet():
    return VGG(make_layers(cfgs['D'], batch_norm=True), num_classes=50)
...
def vgg19_bn_tinyimagenet():
    return VGG(make_layers(cfgs['E'], batch_norm=True), num_classes=50)
