...
"""
__all__=["xception_tinyimagenet", "xception_cifar10"]
import torch
...
def xception_cifar10():
    return Xception(MiddleFLowBlock, num_class=10)

def xception_tinyimagenet():
    return Xception(MiddleFLowBlock, num_class=50)