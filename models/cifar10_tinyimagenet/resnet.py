...
def resnet18_tinyimagenet():
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=50)
...
def resnet34_tinyimagenet():
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=50)


def resnet50_cifar10():
    """Constructs a ResNet-50 nets.
...
def resnet50_tinyimagenet():
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=50)
